          ...
          <div className="relative w-full max-w-3xl rounded-3xl bg-[#0c0d0f] border border-white/10 shadow-2xl shadow-black/60 overflow-hidden">
            ...
            <div className="p-8">
              <div className="text-center mb-8">
                <h2 className="landing-font-display text-2xl font-bold text-white">Buy Credits</h2>
                <p className="mt-2 text-white/50 text-sm">One credit = one image generation. No subscriptions, no expiry.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {PLANS.map((plan) => (
                  ...
                  >
                    {plan.popular && (
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-blue-500/90 text-white text-[10px] font-semibold uppercase tracking-wider">
                        Popular
                      </div>
                    )}
                    ...
                    <div className="text-center mb-5">
                      ...
                      <p className="mt-1 text-white/50 text-sm">{plan.credits} credits</p>
                      <p className="mt-0.5 text-blue-400/80 text-xs font-medium">{plan.perCredit} per credit</p>
                    </div>
